...
import { CommissionType, TargetSettings, Employee } from './types';
...
export const INITIAL_TARGETS: TargetSettings = {
  ...
  commissionValue: 5,
  tiers: [
    { id: '1', from: 0, to: 1000, rate: 0, type: CommissionType.FLAT },
    { id: '2', from: 1001, to: 2000, rate: 1, type: CommissionType.FLAT },
    { id: '3', from: 2001, to: 5000, rate: 5, type: CommissionType.PERCENTAGE },
  ],
};
